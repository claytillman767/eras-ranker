...
export const LEGAL_VERSION = '2026-05-18';
...
export const LEGAL_VERSION_CHANGES_NOTE = 'We changed Pro from a monthly/annual subscription to a single one-time $3.99 unlock. There is no recurring charge, renewal, or cancellation, and we updated the Terms and Privacy Policy to match how billing now works.';
